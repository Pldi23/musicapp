...
<c:set var="page" value="/jsp/library.jsp" scope="request"/>
<html>
...
<div class="container-fluid bg-light">
    <div class="row">
        ...
        <div class="col-8">
            ...
            <%--            <ctg:show-tracks admin="false" tracks="${ tracks }" commandValue="show-all-tracks" nextUnavailable="${ nextunavailable }"--%>
