...
<form action="controller" method="post">
    ...
    <div class="form-group">
        ...
        <input type="date" class="form-control" id="releaseDate" name="releaseFrom" value="${releaseFrom}">
    </div>
    <div class="form-group">
        <label for="releaseDateTo"></label>
        <input type="date" class="form-control" id="releaseDateTo" name="releaseTo" value="${releaseTo}">
    </div>
    <div class="form-group">
