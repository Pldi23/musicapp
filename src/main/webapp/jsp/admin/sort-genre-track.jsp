...
<c:set var="page" value="/jsp/admin/sort-genre-track.jsp" scope="request"/>
...
<ctg:show-tracks tracks="${ entities }" sortCommandValue="sort-track-by-genre" updateCommandValue="to-update-track"
