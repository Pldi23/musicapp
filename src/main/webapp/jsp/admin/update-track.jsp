                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="date" id="datefield" name="releasedate" required value="${ requestScope.entity.releaseDate}"/>
                                <div class="invalid-feedback">
...
<%--                <label>--%>
<%--                    <fmt:message key="label.track.name"/>--%>
<%--                    <input type="text" name="trackname" pattern=".{1,30}(?<!(.mp3)|(.wav)|(.audio)|(.format))$"--%>
<%--                           value="${ requestScope.entity.name }">--%>
<%--                </label>--%>
<%--                <br>--%>
<%--                <label>--%>
<%--                    <fmt:message key="label.singers"/>--%>
<%--                    <c:forEach var="singer" items="${ requestScope.entity.singers}">--%>
<%--                        <input type="text" name="singer" pattern=".{1,30}" value="${ singer.name }">--%>
<%--                    </c:forEach>--%>
