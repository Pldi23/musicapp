...
<c:set var="page" value="/jsp/admin/sort-id-track.jsp" scope="request"/>
...
<ctg:show-tracks tracks="${ entities }" sortCommandValue="sort-track-by-id" updateCommandValue="to-update-track"
