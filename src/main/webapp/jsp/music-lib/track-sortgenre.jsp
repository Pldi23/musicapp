...
<c:set var="pageCommand" value="sort-track-by-genre" scope="request"/>
...
<%--            <ctg:track-table tracks="${ requestScope.entities }" commandValue="sort-track-by-genre"--%>
<%--                             current="${ requestScope.current }" nextUnavailable="${ requestScope.nextunavailable }"--%>
<%--                             previousUnavailable="${ requestScope.previousunavailable }"--%>
<%--                             pages="${ requestScope.size }"/>--%>
<%--        </div>--%>
<%--        <div class="col-2">--%>
