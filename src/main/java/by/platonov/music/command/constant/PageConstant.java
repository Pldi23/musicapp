...
public class PageConstant {
    ...
    public static final String LIBRARY_PAGE = "/jsp/library/library.jsp";
    public static final String LOGIN_PAGE = "/jsp/login.jsp";
    public static final String MAIN_PAGE = "/jsp/main.jsp";
    public static final String MUSICIAN_PAGE = "/jsp/musician.jsp";
    public static final String MUSICIAN_LIBRARY_PAGE = "/jsp/library/library-musician.jsp";
    ...
    public static final String SORT_ID_TRACK_LIBRARY_PAGE = "/jsp/library/library-sort-id-track.jsp";
    public static final String SORT_GENRE_TRACK_LIBRARY_PAGE = "/jsp/library/library-sort-genre-track.jsp";
    public static final String SORT_NAME_TRACK_LIBRARY_PAGE = "/jsp/library/library-sort-name-track.jsp";
    public static final String SORT_LENGTH_TRACK_LIBRARY_PAGE = "/jsp/library/library-sort-length-track.jsp";
    public static final String SORT_NAME_MUSICIAN_LIBRARY_PAGE = "/jsp/library/library-sort-name-musician.jsp";
    public static final String SORT_ID_MUSICIAN_LIBRARY_PAGE = "/jsp/library/library-sort-id-musician.jsp";
    public static final String SORT_ID_GENRE_LIBRARY_PAGE = "/jsp/admin/sort-id-genre.jsp";
    public static final String SORT_NAME_GENRE_LIBRARY_PAGE = "/jsp/admin/sort-name-genre.jsp";
    public static final String SORT_NAME_PLAYLIST_LIBRARY_PAGE = "/jsp/library/library-sort-name-playlist.jsp";
    public static final String SORT_ID_PLAYLIST_LIBRARY_PAGE = "/jsp/library/library-sort-id-playlist.jsp";
    public static final String SORT_LENGTH_PLAYLIST_LIBRARY_PAGE = "/jsp/library/library-sort-length-playlist.jsp";
    public static final String TRACK_PAGE = "/jsp/track.jsp";
    public static final String TRACK_LIBRARY_PAGE = "/jsp/library/library-track.jsp";
    public static final String TRACK_FILTER_LIBRARY_PAGE = "/jsp/admin/filter-track.jsp";
    public static final String UPDATE_TRACK_PAGE = "/jsp/admin/update-track.jsp";
    public static final String UPDATE_MUSICIAN_PAGE = "/jsp/admin/update-musician.jsp";
