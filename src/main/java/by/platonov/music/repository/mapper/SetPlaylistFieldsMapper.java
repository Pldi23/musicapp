...
/**
 * sets playlist's fields to prepared statement which insert {@link Playlist} to db
 *
 * @author dzmitryplatonov on 2019-06-15.
 * @version 0.0.1
 */
public class SetPlaylistFieldsMapper implements PreparedStatementMapper<Playlist> {
    @Override
