 ...
 * @version 0.0.1
 */
public class PlaylistPublicLimitSpecification implements SqlSpecification {
    ...
    public PlaylistPublicLimitSpecification(int limit, long offset, boolean userAdmin) {
        this.limit = limit;
        this.offset = offset;
