...
/**
 * to select entities sorted by name
 *
 * @author Dzmitry Platonov on 2019-07-05.
 * @version 0.0.1
 */
public class EntitySortedNameSpecification implements SqlSpecification {
    ...
    public EntitySortedNameSpecification(boolean isAscending, int limit, long offset) {
