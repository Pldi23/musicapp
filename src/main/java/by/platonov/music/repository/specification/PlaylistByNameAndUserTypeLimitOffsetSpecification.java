 ...
 * @version 0.0.1
 */
public class PlaylistByNameAndUserTypeLimitOffsetSpecification implements SqlSpecification {
    ...
    public PlaylistByNameAndUserTypeLimitOffsetSpecification(String searchRequest, int limit, long offset, User user) {
