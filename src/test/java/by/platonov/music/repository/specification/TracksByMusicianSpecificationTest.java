...
class TracksByMusicianSpecificationTest {

    @Test
    void toPreparedStatement() throws RepositoryException {
        List<Track> actual = TrackRepository.getInstance().query(new TracksByMusicianSpecification(1));
        List<Track> expected = List.of(Track.builder()
                .id(1)
                .name("Tim")
